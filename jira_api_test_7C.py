    ...
    for issue in issues_list:
        ...
        if worklogs:
            for worklog in worklogs:
                ...
                # Write to CSV
                csv_writer.writerow([issue_key, summary, status, comment, author_name, time_spent, worklog_created, extraction_time])
        else:
            csv_writer.writerow([issue_key, summary, status, 'No work records found.', '', '', '', extraction_time])
